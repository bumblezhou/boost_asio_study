...
server::server(const std::string& address, const std::string& port, const std::string& doc_root, std::size_t io_context_pool_size)
...
void server::run() {
  // std::cout << "[server::run()] Current thread=>" << std::this_thread::get_id() << std::endl;
