...
connection::connection(boost::asio::ip::tcp::socket socket, request_handler& handler) : socket_(std::move(socket)), request_handler_(handler) { }
...
void connection::do_read() {
  // std::cout << "[connection::do_read()] Current thread=>" << std::this_thread::get_id() << std::endl;
...
void connection::do_write() {
  // std::cout << "[connection::do_write()] Current thread=>" << std::this_thread::get_id() << std::endl;
  auto self(shared_from_this());
